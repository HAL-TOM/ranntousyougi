...
ID3D11Buffer* CTitleMoveScenePolygon::m_vertexBuffer = nullptr;

CTitleMoveScenePolygon::CTitleMoveScenePolygon()
{
}
...
void CTitleMoveScenePolygon::Load()
{
	VERTEX_3D vertex[4];
...
void CTitleMoveScenePolygon::UnLoad()
{
	m_vertexBuffer->Release();
}
void CTitleMoveScenePolygon::Init()
{

}
void CTitleMoveScenePolygon::Uninit()
{

}
void CTitleMoveScenePolygon::Update()
{

}
void CTitleMoveScenePolygon::Draw()
{
