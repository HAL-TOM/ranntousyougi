...
ID3D11Buffer* CResultBackGround::m_vertexBuffer;
ID3D11ShaderResourceView* CResultBackGround::m_texture;
...
void CResultBackGround::VertexInit()
{
	VERTEX_3D vertex[4];
...
void CResultBackGround::Load()
{
	...
	(
		CRenderer::GetDevice(),
		"asset\\texture\\result_background.png",
		NULL,
		NULL,
		&m_texture,
		NULL
