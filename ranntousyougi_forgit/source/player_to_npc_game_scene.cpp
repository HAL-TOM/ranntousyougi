...
CPlayerToNpcGameScene::CPlayerToNpcGameScene()
{
}
...
void CPlayerToNpcGameScene::Load()
{
	CPiece::Load();
	CPieceDrawer::Load();
	CBord::Load();
	...
	CNumber::Load();
	CPointer::Load();
	//CSound::LoadSound("asset\\sound\\wav\\VsBGM.wav", GetWindow());

}
void CPlayerToNpcGameScene::UnLoad()
{
	CPiece::UnLoad();
	CPieceDrawer::UnLoad();
...
void CPlayerToNpcGameScene::Init()
{
	m_frame = 0;
	...
	CGameManager::SetType(GAME_TYPE_PN);
	//////////////////////////////////////////////////////////////////
	...
	//////////////////////////////////////////////////////////////////
	gameobject = AddGameObject(LAYER_STATE_CAMERA);//ƒJƒƒ‰
	...
	CPlayerBase* player01 = gameobject->AddComponent<CPlayer>();
	player01->Setting(PLAYER_STATE::PLAYER_STATE_01, table);

	gameobject = AddGameObject(LAYER_STATE_D3);//player02
	CNPC* npc = gameobject->AddComponent<CNPC>();
	CPlayerBase* player02 = npc;
...
//	s->m_volume = 0.05f;
//	s->SetSound("asset\\sound\\wav\\VsBGM.wav", GetWindow());
