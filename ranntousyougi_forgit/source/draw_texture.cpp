...
ID3D11Buffer* CDrawTexture::m_vertexBuffer;
ID3D11ShaderResourceView* CDrawTexture::m_texture;

void CDrawTexture::VertexInit()
{
	VERTEX_3D vertex[4];
...
void CDrawTexture::Init()
{

}
void CDrawTexture::Update()
{

}
void CDrawTexture::Uninit()
{

}
void CDrawTexture::Draw()
{
