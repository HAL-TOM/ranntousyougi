...
ID3D11Buffer* CWinnerTexture::m_vertexBuffer;
ID3D11ShaderResourceView* CWinnerTexture::m_texture;
CWinnerTexture::CWinnerTexture()
{
}
...
void CWinnerTexture::VertexInit()
{
	VERTEX_3D vertex[4];
...
void CWinnerTexture::UnLoad()
{
	m_texture->Release();
	m_texture = nullptr;
}
void CWinnerTexture::Init()
{

}
void CWinnerTexture::Uninit()
{

}
void CWinnerTexture::Update()
{

}
void CWinnerTexture::Draw()
{
