...
ID3D11Buffer* CLooseTexture::m_vertexBuffer;
ID3D11ShaderResourceView* CLooseTexture::m_texture;


void CLooseTexture::VertexInit()
{
	VERTEX_3D vertex[4];
...
void CLooseTexture::UnLoad()
{
	m_texture->Release();
	m_texture = nullptr;
}

CLooseTexture::CLooseTexture()
{
}
...
void CLooseTexture::Init()
{

}
void CLooseTexture::Update()
{

}
void CLooseTexture::Uninit()
{

}
void CLooseTexture::Draw()
{
