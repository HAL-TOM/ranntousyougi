...
ID3D11Buffer* CRightPolygon::m_vertexBuffer = nullptr;
ID3D11ShaderResourceView* CRightPolygon::m_texture = nullptr;
CRightPolygon::CRightPolygon()
{
}
...
void CRightPolygon::UnLoad()
{
	m_vertexBuffer->Release();
	m_texture->Release();
}
void CRightPolygon::Init()
{

}
void CRightPolygon::Uninit()
{

}
void CRightPolygon::Update()
{

}
void CRightPolygon::Draw()
{
