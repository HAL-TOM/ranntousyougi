...
ID3D11Buffer* CLeftPolygon::m_vertexBuffer = nullptr;
ID3D11ShaderResourceView* CLeftPolygon::m_texture = nullptr;

CLeftPolygon::CLeftPolygon()
{
}
...
void CLeftPolygon::UnLoad()
{
	m_vertexBuffer->Release();
	m_texture->Release();
}
void CLeftPolygon::Init()
{

}
void CLeftPolygon::Uninit()
{

}
void CLeftPolygon::Update()
{

}
void CLeftPolygon::Draw()
{
