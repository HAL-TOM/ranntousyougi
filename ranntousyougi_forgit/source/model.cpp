...
float CModel::GetModelAlpha()
{
	return m_modelAlpha;
}
void CModel::SetModelAlpha(float set)
{
	m_modelAlpha = set;
}
void CModel::Init()
...
void CModel::ModelDraw()
{
	...
	{
		material = m_SubsetArray[i].Material.Material;
		if (material.Ambient.a > m_modelAlpha)
		{
			material.Ambient.a = m_modelAlpha;
		}
		if (material.Diffuse.a > m_modelAlpha)
		{
			material.Diffuse.a = m_modelAlpha;
		}
		if (material.Emission.a > m_modelAlpha)
		{
			material.Emission.a = m_modelAlpha;
		}
		if (material.Specular.a > m_modelAlpha)
		{
			material.Specular.a = m_modelAlpha;
		}
		// マテリアル設定
