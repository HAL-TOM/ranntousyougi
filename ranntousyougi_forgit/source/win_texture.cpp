...
ID3D11Buffer* CWinTexture::m_vertexBuffer;
ID3D11ShaderResourceView* CWinTexture::m_texture;


void CWinTexture::VertexInit()
{
	VERTEX_3D vertex[4];
...
void CWinTexture::UnLoad()
{
	m_texture->Release();
	m_texture = nullptr;
}

CWinTexture::CWinTexture()
{
}
...
void CWinTexture::Init()
{

}
void CWinTexture::Update()
{

}
void CWinTexture::Uninit()
{

}
void CWinTexture::Draw()
{
